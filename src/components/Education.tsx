...
const EducationTimeline = () => {
  ...
  return (
    <div className="h-[calc(100vh-40px)]  w-full pt-[6px] flex items-center justify-center">
      ...
      <div className=" py-64 h-full overflow-x-hidden w-[calc(100vw-2px)] flex items-center justify flex-col
       pr-[2px] overflow-y-auto snap-y gap-[100vh] snap-mandatory ">
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0, width:'5px', height: "58%" }}  // Fall down to position (y: 0) and increase height
      ...
      {educationData.map((edu, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
            className=" bg-black/0 parent snap-center flex items-center mb-10 relative"
          >
            <motion.div 
            initial={{ opacity: 0}}

...
const Introduction: React.FC = () => {
  ...
  return (
    <div className='min-w-screen min-h-screen bg-black/0 flex max-sm:flex-col max-md:flex-col'>
      <div className='_left w-[50%] max-md:w-full px-24 max-sm:px-5 max-sm:py-10 py-28 min-h-full bg-blue-400/0 max-sm:w-full max-sm:h-fit mt-[9vh] max-md:pb-2 max-md:mt-0 max-md:pt-10 max-sm:pb-4'>
